...
option_list <- list(
  ...
  make_option(c("-r", "--reference-ids"), type="character", default=NULL,
              ...
              dest="refIDs"),
  make_option(c("--lenFile"), type="numeric", default=NULL,
			  help="length of all sequences",
			  dest="lenFile"),
  make_option(c("--HORFile"), type="character", default=NULL,
              help="HOR bed of all seuqences",
              dest="HORFile"),
...
len = read.table(opt$lenFile, stringsAsFactors = F, h=F)
colnames(len) = c('scaf', 'len')
